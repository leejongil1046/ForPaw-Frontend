      ...
      <S.WrapperDogs>
        <S.DogsMainContainer>
          ...
          <S.DogsMainTitleBlock>
            <S.DogsMainTitle>반려견과<br />함께 생활하는 방법</S.DogsMainTitle>
            <S.DogsTitleContent>
              강아지와 함께 살아가는 법,<br />
              포포와 함께 알아봐요!
            </S.DogsTitleContent>
        ...
        <S.DogsContentsContainer>
          <S.DogsContentsTitle>식사는 규칙적으로, 필요한 양만큼</S.DogsContentsTitle>
        ...
        <S.DogsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.DogsContentsDetail>
            반려견의 건강을 유지하기 위해 정기적인 예방접종이<br />
            필요해요. 내/외부 기생충 퇴치를 위해 적절한 예방책을<br />
        ...
        <S.DogsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.DogsContentsDetail>
            산책을 통해 건강을 유지하고 새로운 자극으로 정신적으로<br />
            활동적으로 만들어 줄 수 있어요.  다른 강아지와 만나<br />
        ...
        <S.DogsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.DogsContentsDetail>
            ...
            주인의 애정과 관심이에요. 꾸준한 교감과 애정표현으로<br />
