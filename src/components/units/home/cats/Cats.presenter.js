    ...
    <>
      <S.WrapperCats>
        ...
        <S.CatsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.CatsContentsDetail>
            정기적으로 동물병원에 방문하고 예방정종을 해주는게<br />
            좋아요. 또한 털 뭉침를 방지하기 위해 브러시를 사용하고,<br />
        ...
        <S.CatsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.CatsContentsDetail>
            고양이는 사냥본능이 강한 편이라 장난감을 제공해 놀이와<br />
            활동을 유도해야해요. 고양이의 스트레스 해소에도 도움이<br />
        ...
        <S.CatsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.CatsContentsDetail>
            고양이의 발톱은 길고 날카로워서 사람이 정리해주지<br />
            않으면 발톱이 부러지거나, 다른 사람이나 고양이에게<br />
            상처를 입힐 수 있어요.
          </S.CatsContentsDetail>
          <Image
        ...
        <S.CatsContentsContainer style={{ marginTop: "60px" }}>
          ...
          <S.CatsContentsDetail>
            고양이는 주인의 관심과 애정을 중요하게 여겨요.<br />
            꾸준한 상호작용과 교감을 통해 고양이와의 유대감을<br />
